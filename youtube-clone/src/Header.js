    ...
    return (
        <div className="header">
           ...
           <div className="header__input">
            <input onChange={e => setInputSearch(e.target.value)} value={inputSearch} type="text" placeholder="Search Videos and channels"></input>
          ...
          <VideoCallIcon className="header__icon"></VideoCallIcon>
            ...
            <NotificationIcon className="header__icon"></NotificationIcon>
            <Avatar
            src=""
            ></Avatar>
          </div>
